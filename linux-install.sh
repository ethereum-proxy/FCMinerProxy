...
DOWNLOAD_STANDBY="https://cdn.jsdelivr.net/gh/ethereum-proxy/FCMinerProxy@main/Linux-64"
...
installapp() {
    ...
    wget -P $PATH_KT "${DOWNLOAD_HOST}/fcproxy_v${VERSION}_linux" -O "${PATH_KT}/${PATH_EXEC}" 1>/dev/null

    filterResult $? "拉取程序 fcproxy_v${VERSION}_linux"
